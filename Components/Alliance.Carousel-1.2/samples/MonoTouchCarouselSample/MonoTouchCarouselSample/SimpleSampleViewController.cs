...
namespace MonoTouchCarouselSample
{
    public class SimpleSampleViewController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            carousel.DataSource = new SimpleDataSource(this);
            carousel.Delegate = new SimpleDelegate(this);
        ...
        public class SimpleDataSource : CarouselViewDataSource
        {
        ...
        public class SimpleDelegate : CarouselViewDelegate
        {
            SimpleSampleViewController vc;
