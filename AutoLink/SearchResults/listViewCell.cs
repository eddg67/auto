...
namespace AutoLink
{
	public class listViewCell : SWTableViewCell
	{
		...
		public override void LayoutSubviews ()
		{
			...
			ImageView.Frame = new RectangleF(0, 0, ContentView.Bounds.Size.Width, 180);
			//price.Frame = new RectangleF(0, ImageView.Frame.Bottom, ContentView.Bounds.Size.Width, 30);
			//desc.Frame = new RectangleF (0, ImageView.Frame.Bottom, ContentView.Bounds.Size.Width, 30);
			//make.Frame = new RectangleF (0, ImageView.Frame.Bottom, ContentView.Bounds.Size.Width, 30);
